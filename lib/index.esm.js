...
const Button = (_a) => {
    ...
    return (React.createElement("button", Object.assign({ type: "button", className: `button button--${variant}`, style: { color: labelColor, backgroundColor: bgColor } }, props), isLoading ?
        (React.createElement("div", { style: { display: "flex", alignItems: "center" } },
            React.createElement("div", { className: `loader loader--${fontSize}`, style: props.loadingLabel ? { marginRight: "0.5rem" } : {} }),
