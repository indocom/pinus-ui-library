import React, { forwardRef, useState, useContext, createElement, Fragment, createContext, useRef, useLayoutEffect, Component, useMemo, useCallback, useEffect } from 'react';
import require$$1$1, { createPortal } from 'react-dom';
 ...
 */
const Button = (_a) => {
    var { variant = "primary", bgColor, label, labelColor, isLoading = false, fontSize = "lg" } = _a, props = __rest(_a, ["variant", "bgColor", "label", "labelColor", "isLoading", "fontSize"]);
    if (isLoading) {
        props.disabled = true;
    }
    return (React.createElement("button", Object.assign({ type: "button", className: `button button--${variant}`, style: { color: labelColor, backgroundColor: bgColor } }, props), isLoading ?
        (React.createElement("div", { style: { display: "flex", alignItems: "center" } },
            React.createElement("div", { className: `loader loader--${fontSize}`, style: props.loadingLabel ? { marginRight: "0.5rem" } : { fontSize: "1rem" } }),
            React.createElement(Text, { color: "#ffffff", fontWeight: "bold", fontSize: fontSize }, props.loadingLabel))) : (React.createElement(Text, { color: "#ffffff", fontWeight: "bold", fontSize: fontSize }, label))));
};

var css_248z$8 = "header {\n  z-index: 5;\n  width: 90vw;\n}\n\n.wrapper {\n  padding: 15px 20px;\n  display: flex;\n  align-items: center;\n  width: calc(100vw - (100vw - 100%));\n  justify-content: space-between;\n  background-color: transparent;\n}\n\n.wrapper2 {\n  padding: 15px 20px;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  width: calc(100vw - (100vw - 100%));\n  justify-content: space-between;\n  background-color: transparent;\n  position: relative;\n}\n\n@media (max-width:1050px) {\n  .wrapper {\n    display: none;\n  }\n\n  .wrapper2 {\n    visibility: visible\n  }\n}\n\n@media (min-width:1050px) {\n  .wrapper {\n    visibility: visible;\n  }\n\n  .wrapper2 {\n    display: none;\n  }\n\n  .header2 {\n    display: none;\n  }\n}\n\n.dropdownHeader {\n  outline: none !important;\n  border: none !important;\n  padding: 0 !important;\n  background-color: transparent;\n}\n\n.title {\n  min-width: 150px;\n  overflow: hidden;\n  white-space: nowrap;\n  margin: 10px;\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  min-width: 60%;\n  justify-content: right;\n  justify-items: right;\n  text-align: end;\n}\n\n.header2 {\n  width: calc(100vw - (100vw - 100%));\n  padding: 0 20px;\n  justify-content: center;\n  justify-items: center;\n  text-align: center;\n  background-color: black;\n  position: block;\n}\n\n.logoAndTitle {\n  justify-content: space-between;\n  display: flex;\n}\n\n.logoAndTitle > img {\n  width:auto;\n  height:100%;\n  margin-top: auto;\n  margin-bottom: auto;\n}\n\n.logoAndTitleWrapper {\n  display:\"block\";\n  justify-content: left;\n}\n\n.header > a > p {\n  display: inline !important;\n}\n\n.header > a > p:hover {\n  color: red !important;\n  transition: 0.3s;\n}\n\n.header > a + a {\n  margin-left: 30px;\n}\n\n.header2 > a > p {\n  display: block;\n  color: white !important;\n  padding: 5px 0;\n}\n\n.header2 > a > p:hover {\n  color: red !important;\n  transition: 0.3s;\n}\n";
...
var Menu$1 = forwardRef(function (_ref, ref) {
...
const Header = ({ logoPath, headerTitle, user, headers, homeLink, onLogin, onLogout, isLoginSupported = false, }) => {
    ...
    return (React.createElement("header", null,
        React.createElement("div", { className: "wrapper" },
            React.createElement("a", { className: "logoAndTitleWrapper", href: homeLink },
                React.createElement("div", { className: "logoAndTitle" },
                    React.createElement("img", { src: logoPath ? logoPath : logo }),
                    React.createElement("div", { className: "title" }, headerTitle))),
            React.createElement("div", { className: "header" }, headers &&
                headers.map((header) => React.createElement("a", { href: header.url }, header.label))),
            isLoginSupported &&
                (user ? (React.createElement(Button, { onClick: onLogout, label: "Log out", variant: "primary" })) : (React.createElement(Button, { onClick: onLogin, label: "Log in", variant: "primary" })))),
        React.createElement("div", { className: "wrapper2" },
            React.createElement("a", { className: "logoAndTitleWrapper", href: homeLink },
                React.createElement("div", { className: "logoAndTitle" },
                    React.createElement("img", { src: logoPath ? logoPath : logo }))),
            React.createElement("button", { onClick: () => setIsDrawerOpen(!isDrawerOpen), className: "dropdownHeader" },
                React.createElement(Menu$2, { size: 32 }))),
        isDrawerOpen && (React.createElement("div", { className: "header2" }, headers &&
            headers.map((header) => React.createElement("a", { href: header.url },
                " ",
                header.label,
                " "))))));
};
...
const Dropdown = ({ options, placeholder, onChange, isMulti = false, }) => (React.createElement(Select, { onChange: onChange, isClearable: true, autoFocus: true, placeholder: placeholder, closeMenuOnSelect: true, options: options, isMulti: isMulti, styles: customStyles }));
...
(function (global, factory) {
  {
    factory(exports, React, propTypes.exports);
  }
...
var _reactDom = _interopRequireDefault(require$$1$1);
...
const Carousel = ({ interval = 5000, transitionTime = 1000, imgList }) => {
    const prevArrow = (onClickHandler, hasPrev, label) => {
        return hasPrev &&
            React.createElement("button", { type: "button", onClick: onClickHandler, title: label, style: Object.assign(Object.assign({}, arrowStyles), { left: 15 }) },
                React.createElement("i", { style: Object.assign(Object.assign({}, arrow), left) }));
    };
    const nextArrow = (onClickHandler, hasNext, label) => {
        return hasNext &&
            React.createElement("button", { type: "button", onClick: onClickHandler, title: label, style: Object.assign(Object.assign({}, arrowStyles), { right: 15 }) },
                React.createElement("i", { style: Object.assign(Object.assign({}, arrow), right) }));
    };
    const indicator = (onClickHandler, isSelected, index, label) => {
        return isSelected
            ? (React.createElement("li", { style: Object.assign(Object.assign({}, indicatorStyles), { background: "#FF1313" }), "aria-label": `Selected: ${label} ${index + 1}`, title: `Selected: ${label} ${index + 1}` }))
            : (React.createElement("li", { style: indicatorStyles, value: index, key: index, role: "button", onClick: onClickHandler, tabIndex: 0, title: `${label} ${index + 1}`, "aria-label": `${label} ${index + 1}` }));
    };
    return (React.createElement(js.Carousel, { autoPlay: true, infiniteLoop: true, swipeable: true, emulateTouch: true, interval: interval, transitionTime: transitionTime, showThumbs: false, renderArrowPrev: prevArrow, renderArrowNext: nextArrow, renderIndicator: indicator }, imgList.map((src, id) => {
        return (React.createElement("div", { key: id },
            React.createElement("img", { src: src })));
    })));
};

var css_248z$6 = ".contentCard {\n    display: flex;\n    flex-flow: column;\n    max-width: 20rem;\n    justify-content: flex-start;\n\n    background-repeat: no-repeat;\n    background-size: cover;\n\n    border: 1px;\n    border-radius: 1rem;\n    box-shadow: 7px 7px 7px grey;\n    margin-top: 1rem;\n    margin-left: 1rem;\n    margin-right: 1rem;\n}\n\n.image {\n    display: flex;\n    justify-content: center;\n    max-width: 100%;\n    padding-bottom: 1rem;\n    border-radius: 1rem;\n}\n\nimg {\n    width: auto;\n    height: auto;\n    max-width: 100%;\n    max-height: 100%;\n    object-fit: fit;\n}\n\n.imgcard{\n    border-radius: 1rem 1rem 0rem 0rem;\n}\n\n.title {\n    /* To be replaced with appropriate component */\n    font-size: 1.5rem;\n    font-weight: bolder;\n    justify-content: center;\n    line-height: 2rem;\n    margin-top: 1rem;\n    margin-left: 1rem;\n    margin-right: 1rem;\n}\n\n.description {\n    align-items: center;\n    margin-left: 1rem;\n    margin-right: 1rem;\n    padding-top: 0.75rem;\n    padding-bottom: 1rem;\n    padding-left: 0.5rem;\n    padding-right: 0.5rem;\n    \n    overflow: hidden;\n    text-overflow: ellipsis;\n    text-align: justify;\n    text-justify: newspaper;\n}\n\n.from{\n    display: flex;\n    text-align: right;\n    justify-content: end;\n    color: grey;\n    font-size: smaller;\n    margin-left: 1rem;\n    margin-right: 2rem;\n    margin-bottom: 1rem;\n}\n\n.hyperlink {\n    display: flex;\n    justify-content: end;\n    margin-left: 1rem;\n    margin-right: 1rem;\n    margin-bottom: 0.5rem;\n}\n\n.hyperlink > a:visited{\n    color: #FF3B3A;\n    text-decoration: underline;\n}\n\n.hyperlink > a:hover {\n    color: red;\n    text-decoration: underline;\n}\n\n/* sm-min */\n@media screen and (min-width: 640px) {\n    .contentCard {\n        max-width: 20rem;\n    }\n    \n}\n/* md-min */\n@media screen and (min-width: 768px) {\n    .contentCard {\n        max-width: 28rem;\n    }    \n}\n\n/* lg-min */\n@media screen and (min-width: 1024px) {\n    .contentCard {\n        height: auto;\n    }\n    \n    .image {\n        max-width: 32rem;\n    }\n\n    .title {\n        margin-left: 1.5rem;\n        margin-right: 1.5rem;\n    }\n\n    .description {\n        padding-top: 0rem;\n        margin-top: 0.5rem;\n        margin-left: 1.5rem;\n        margin-right: 1.5rem;\n        max-height: 9rem;\n    }\n\n    .hyperlink {\n        margin-left: 1.5rem;\n        margin-right: 1.5rem;\n    }\n    \n}\n\n/* xl-min */\n@media screen and (min-width: 1280px) {\n    .contentCard {\n        padding-bottom: 2rem;\n    }\n}\n\n/* 2xl-min: */\n@media screen and (min-width: 1536px) {\n    .description {\n        max-height: 10rem;\n    }\n}";
styleInject(css_248z$6);

const ContentCard = ({ image, imgAlt, title, description, from, hyperlink, bgImage = "https://www.publicdomainpictures.net/pictures/210000/nahled/paper-texture-crean-background.jpg", }) => {
    return (React.createElement("div", { className: 'contentCard', style: { backgroundImage: `url(${bgImage})` } },
        React.createElement("div", { className: 'image' }, image
            ? React.createElement("img", { className: 'imgcard', src: image, alt: imgAlt })
            : React.createElement(React.Fragment, null)),
        React.createElement("div", { className: 'title' }, title),
        React.createElement("div", { className: 'description' }, description),
        React.createElement("div", { className: 'from' }, from),
        React.createElement("div", { className: 'hyperlink' },
            React.createElement("a", { href: hyperlink }, "Read More >>>"))));
};

var css_248z$5 = ".input {\n    font-family: ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,\n    \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif,\n    \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";\n    \n    width: 100%;\n    max-width: 100%;\n\n    border-radius: 0.5rem;\n    padding: 1.25rem;\n\n    color: black;\n}\n\n.input--outlined {\n    border: 0.1em solid gray;\n}\n\n.input--filled {\n    border: 0.1em solid #eeeeee;\n    background-color: #eeeeee;\n}\n\n.input:focus {\n    outline: none !important;\n    border: 0.15em solid #1E88E5;\n}\n\n.input:invalid {\n    outline: none !important;\n    border: 0.15em solid red;\n}";
...
const Input = (_a) => {
    ...
    return React.createElement("input", Object.assign({ className: `input input--${variant}` }, props, { required: isRequired }));
};
...
const TextArea = (_a) => {
    ...
    return (React.createElement("textarea", Object.assign({ className: `textarea textarea--${variant}`, rows: numRows }, props, { required: isRequired })));
};
...
const Banner = (_a) => {
    ...
    return (React.createElement("div", { className: `banner--wrapper` },
        React.createElement("img", { className: "banner--backgroundImage", src: bgImage }),
        React.createElement("div", { className: "banner--title" }, title),
        subHeader != null &&
            React.createElement("div", { className: "banner--subheader" }, subHeader)));
};
...
const Footer = (_a) => {
    ...
    logoTitle = logoTitle ? logoTitle : React.createElement(Text, { fontSize: "4xl", fontWeight: "bold", color: "black" }, " PINUS ");
    rightSide = rightSide ? rightSide :
        React.createElement("div", { style: { backgroundColor: "black" } },
            React.createElement(Text, { color: "white" }, " Put whatever you want here "));
    return (React.createElement("div", { className: "footerWrapper" },
        React.createElement("div", { className: "columnWrapper" },
            React.createElement("div", { className: "footerLogoAndTitle" },
                React.createElement("img", { src: logoPath, className: "footerLogo" }),
                logoTitle),
            React.createElement(Text, { color: "gray" }, "\u00A92021 Perhimpunan Indonesia NUS. All Rights Reserved.")),
        React.createElement("div", { className: "rightSideWrapper" },
            links &&
                links.map((col) => {
                    return (React.createElement("div", { className: "linksWrapper" },
                        ...
                        col.pages.map((page) => {
                            return React.createElement("a", { href: page.link, className: "footerLink" },
                                React.createElement(Text, { color: "black", fontSize: "xs" }, page.title));
                        })));
                }),
            React.createElement("div", { className: "linksWrapper" }, rightSide))));
};
...
const Navbar = (_a) => {
    ...
    function renderContents(contents, level) {
        ...
        return contents.map(content => {
            if (level === 0) {
                return (React.createElement("div", { className: "navbarHeading" },
                    React.createElement("a", { href: content.path },
                        React.createElement(Text, { fontSize: "3xl", fontWeight: "bold", color: color },
                            " ",
                            content.title,
                            " ")),
                ...
                console.log(tabs);
                return (React.createElement("div", null,
                    React.createElement("a", null, tabs),
                    React.createElement("a", { href: content.path, className: "navbarLink" },
                        React.createElement(Text, { fontSize: "lg", color: color, display: "inline" },
                            tabs,
                            " ",
                            content.title,
                            " ")),
    ...
    return (React.createElement("div", null, renderContents(contents, 0)));
};

export { Banner, Button, Carousel, ContentCard, Dropdown, Footer, Header, Input, Navbar, Text, TextArea };
