...
const Button = (_a) => {
    ...
    return (React__default['default'].createElement("button", Object.assign({ type: "button", className: `button button--${variant}`, style: { color: labelColor, backgroundColor: bgColor } }, props), isLoading ?
        (React__default['default'].createElement("div", { style: { display: "flex", alignItems: "center" } },
            React__default['default'].createElement("div", { className: `loader loader--${fontSize}`, style: props.loadingLabel ? { marginRight: "0.5rem" } : { fontSize: "1rem" } }),
            React__default['default'].createElement(Text, { color: "#ffffff", fontWeight: "bold", fontSize: fontSize }, props.loadingLabel))) : (React__default['default'].createElement(Text, { color: "#ffffff", fontWeight: "bold", fontSize: fontSize }, label))));
};
...
const ContentCard = ({ image, imgAlt, title, description, from, hyperlink, bgImage = "https://www.publicdomainpictures.net/pictures/210000/nahled/paper-texture-crean-background.jpg", }) => {
    return (React__default['default'].createElement("div", { className: 'contentCard', style: { backgroundImage: `url(${bgImage})` } },
        React__default['default'].createElement("div", { className: 'image' }, image
            ? React__default['default'].createElement("img", { className: 'imgcard', src: image, alt: imgAlt })
        ...
        React__default['default'].createElement("div", { className: 'from' }, from),
