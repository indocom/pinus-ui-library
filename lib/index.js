...
const Button = (_a) => {
    ...
    return (React__default['default'].createElement("button", Object.assign({ type: "button", className: `button button--${variant}`, style: { color: labelColor, backgroundColor: bgColor } }, props), isLoading ?
        (React__default['default'].createElement("div", { style: { display: "flex", alignItems: "center", fontSize: "1em", lineHeight: "normal" } },
            React__default['default'].createElement("div", { className: "loader", style: props.loadingLabel ? { marginRight: "0.5rem" } : { fontSize: "1rem" } }),
